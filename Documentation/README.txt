=======================================================================
To run the project succesfuly, you need to connect to UiPath Orchestrator - then set up a Queue and change its name and its folder in the Config.xlsx file (or just set it up how it says there).
=======================================================================
...
- I've also put the project on my github: https://github.com/swronskiedu/InvoiceScrapper
